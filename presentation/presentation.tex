...
\author[Поликутин Е.Ю.]{
    ...
    \indent\vbox{\raggedright%
        ...
        Консультант: Олейников Игорь Сергеевич,\\аналитик данных ООО <<Амаяма Авто>>
...
\begin{document}
    ...
    \note{Защищается студент группы М9119-09.04.01иибд ДВФУ Поликутин Евгений Юрьевич по теме Система автоматизированного A/B тестирования. Научный руководитель --- кандидат технических наук Шевченко Игорь Иванович. Консультант --- аналитик данных ООО <<Амаяма Авто>> Олейников Игорь Сергеевич}
	...
	\begin{frame}[fragile]{Краткие характеристики системы}
		\begin{block}{}
			\begin{itemize}
	...
	\note{
		Для корректного непрерывного мониторинга тестов классические статистические критерии, такие как t-тест Стьюдента не подходят --- из-за проблемы множественного сравнения реальный уровень значимости резко возрастает, увеличивая вероятность ошибок 1 рода, и поэтому в работе применяется критерий mSPRT, специально предназначенный для такого сценария, и его модификации. Стоит отметить, что для этого теста играет роль выбор смешивающего распределения, которое играет роль априорной оценки эффекта теста.
	}
