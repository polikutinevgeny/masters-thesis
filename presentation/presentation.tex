...
\begin{document}
    ...
    \note{Защищается студент группы М9119-09.04.01иибд ДВФУ Поликутин Евгений Юрьевич по теме Система автоматизированного A/B тестирования. Консультант --- аналитик данных ООО <<Амаяма Авто>> Олейников Игорь Сергеевич}
